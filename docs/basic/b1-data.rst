...
These requirements are met on OSGeoLive. When the required software is installed, 
open a terminal window by pressing :code:`ctrl-alt-t` and follow the instructions.
Information about installing OSGeoLive can be found on :doc:`../general-intro/g3-osgeolive`.
...
.. literalinclude:: ../scripts/get-data/get-osgeolive-data.sh
   :start-after: osgeolive data from-here
   :end-before:  osgeolive data to-here
   :language: bash
   :linenos:
